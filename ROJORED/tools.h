...
uint32_t color[8] = { 0x000000, // NONE
  0xFF0000, // RED
  0xFF8000, // ORANGE
  0xFFFF00, // YELLOW
  0x00FF00, // GREEN
...
int currentRandom = 0;
const prog_uchar pseudo_random[64] PROGMEM = { 70, 125,  27, 134, 243, 234,  34,  29,
      63,  35, 253,  62, 196,   5, 220, 244,
     192, 120,  26,  56, 126, 163, 100, 157,
       6,  11, 161, 189, 141, 207, 129, 132,
      19, 249, 157,  42, 120, 193, 110, 224,
     152, 180, 241,   3, 218,  29, 240,  45,
     199,  72, 229, 144, 146,  31, 198,  27,
      21,  76, 104,  86, 139, 162, 216,  28 };

unsigned char get_random() {
  unsigned char randomVal = pgm_read_byte_near(pseudo_random + currentRandom);
  currentRandom++;
  return randomVal;
}
